python context_selection.py --mode test --context_path "${1}" --input_file "${2}" --pretrained_model hfl/chinese-roberta-wwm-ext
python to_SQuAD.py --context "${1}" --input_file ./selection.json
